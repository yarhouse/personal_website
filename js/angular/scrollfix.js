...
// console.log('******** Loading Scrollfix module');
angular.module('ui.scrollfix',[]).directive('uiScrollfix', ['$window', function ($window) {
  // console.log('******** In the Scrollfix module');
  function getWindowScrollTop() {
    // console.log('******** Firing off getWindowScrollTop');
    if (angular.isDefined($window.pageYOffset)) {
      // console.log('******** Angular is defined', $window.pageYOffset);
      return $window.pageYOffset;
    } else {
      // console.log('******** Angular isnt defined, oh no!!',);
